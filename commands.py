...
then
	...
	curl -u admin:python -i -H "Content-Type: application/json" -X POST -d '{"name":'$name', "range":'$range', "network":'$subnet', "gateway":'$gateway', "interface":'$interface'}' http://localhost:5000/add/dhcp
fi
