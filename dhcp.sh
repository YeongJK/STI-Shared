...
then
	python dhcp.py updateserver $argument1 $argument2 $argument3 > updateserver.txt
...
then
	python dhcp.py adddhcp $argument1 $argument2 $argument3 $argument4 $argument5 $argument6 > adddhcp.txt
