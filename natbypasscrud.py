...
class ApiRos:
    ...
    def deleteNatbypass(self, numbers):
...
def main():
    ...
    if sys.argv[1] == "printnatbypass":
	apiros.printNatbypass();
    ...
    elif sys.argv[1] == "deletenatbypass":
        apiros.deleteNatbypass(sys.argv[2]);
